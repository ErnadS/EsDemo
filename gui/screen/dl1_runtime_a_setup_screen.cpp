...
Dl1RuntimeASetupScreen::Dl1RuntimeASetupScreen(QWidget* parent) : BaseRuntimeSetupScreen(parent)
{   
    m_title_widget->setTitle("DL2 Runtime Screen A Setup");
    m_runtime_screen = new RuntimeScreen(this, RuntimeScreenType::RUNTIME_DL1, true);
