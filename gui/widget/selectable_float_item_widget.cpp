...
SelectableFloatItemWidget::SelectableFloatItemWidget(QWidget* parent, QSize base_size, QString title, QString unit, Validator* validator) : SelectableItemWidget(parent, base_size, title, unit, validator)
{
